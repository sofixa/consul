...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to create the role within.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the role within. This takes precedence over the `ns` query parameter,
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL role to read.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to lookup the role within.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `id` `(string: <required>)` - Specifies the UUID of the role to update.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the role to update.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the role to update. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL role to delete.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the role to delete.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to list the roles for.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).

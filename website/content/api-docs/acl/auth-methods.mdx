...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to create
  the auth method within.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the auth method within. This takes precedence over the `ns` query parameter,
...
- `name` `(string: <required>)` - Specifies the name of the ACL auth method to update.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the auth method to update.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).

### JSON Request Body Schema

- `Name` `(string: <optional>)` - If specified, it must exactly match the `name` path parameter.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the auth method to update. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).

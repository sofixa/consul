...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the policy within.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the policy within. This takes precedence over the `ns` query parameter,
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL policy to read.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to lookup the policy.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `id` `(string: <required>)` - Specifies the UUID of the policy to update.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the policy to update.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).

### JSON Request Body Schema

- `ID` `(string: <optional>)` - If specified, it must exactly match the `id` path parameter.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the policy to update. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL policy to delete.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the policy to delete.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to list the policies for.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` field of the JSON request body -
  only applies to [create](#create-a-policy) and [update](#update-a-policy) endpoints
- `ns` query parameter
- `X-Consul-Namespace` request header
- Namespace is inherited from the namespace of the request's ACL token (if any)

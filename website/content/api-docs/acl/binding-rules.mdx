...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the binding rule within.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the binding rule within. This takes precedence over the `ns` query parameter,
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL binding rule to update.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to lookup the binding rule.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the binding rule to update. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `id` `(string: <required>)` - Specifies the UUID of the ACL binding rule to delete.

### Query Parameters

- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the binding rule to delete.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to list the binding rules for.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).

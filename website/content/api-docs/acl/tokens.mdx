...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to create the token within.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to
  create the token within. This takes precedence over the `ns` query parameter,
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to lookup the token within.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the token to update.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the token to update. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the token to be cloned.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of
  the token to be cloned. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace of the token to delete.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to list the tokens for.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).

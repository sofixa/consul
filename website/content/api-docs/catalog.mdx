...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace in which the service and checks will be registered.
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace in
  which the service and checks will be registered. This takes precedence over the `ns` query parameter,
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace in which the service and checks will be deregistered.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
...
- `Namespace` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace in
  which the service and checks will be deregistered. This takes precedence over the `ns` query parameter,
  one of several [other methods to specify the namespace](#methods-to-specify-namespace).
...
- `ns` `(string: "")` <EnterpriseAlert inline /> - Specifies the namespace to use for the query.
  The namespace can also be specified [through other methods](#methods-to-specify-namespace).
